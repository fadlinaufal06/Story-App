...
import com.intermediate.storyapp.databinding.ActivityUploadStoryBinding
import com.intermediate.storyapp.helper.Helper
import com.intermediate.storyapp.view.camera.CameraActivity
...
class UploadStoryActivity : AppCompatActivity() {
    ...
    private val launcherIntentGallery = registerForActivityResult(
        ...
        if (it.resultCode == RESULT_OK) {
            ...
            val myFile = Helper.uriToFile(selectedImg, this@UploadStoryActivity)
            getFile = myFile
    ...
    private fun uploadStory() {
        when {
            ...
            getFile != null -> {
                        ...
                        when (it) {
                            ...
                            is ResultResponse.Error -> {
                                ...
                                AlertDialog.Builder(this).apply {
                                    ...
                                    setPositiveButton(getString(R.string.continue_to)) { _, _ ->
                                        binding.progressBar.visibility = View.GONE
                                    }
                                    create()
                                    show()
                ...
                Helper.showToastShort(this@UploadStoryActivity, getString(R.string.no_file_uploaded))
            }
        }
    }
        ...
        if (ContextCompat.checkSelfPermission(
            ...
            fusedLocationClient.lastLocation.addOnSuccessListener {
                if (it != null) {
                    ...
                    Helper.showToastLong(this, getString(R.string.location_permission))
